...
We get superior reconstructions compared to traditional image-processing \rephrase{methods}, especially when the images have been downsampled four times.
...
Lastly, we also investigate to a lesser extent whether the variational auto-encoder is independent of resolution and find that it is \rephrase{in some cases}.
