...
\end{itemize}
Our Python implementation of the model, \texttt{super\_resolution.py} \footnote{Available at \url{https://github.com/chgroenbech/aml-project}.}, are made using the \texttt{Theano}, \texttt{Lasagne} and \texttt{Parmesan} packages. 
