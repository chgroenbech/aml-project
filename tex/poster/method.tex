...
\subsection{Reparameretization trick} % (fold)
\label{sub:reparameretization_trick}

% subsection reparameretization_trick (end)

\subsection{Layers of neural networks} % (fold)
\label{sub:layers_of_neural_networks}

% subsection layers_of_neural_networks (end)
